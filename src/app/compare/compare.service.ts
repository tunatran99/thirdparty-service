...
// import { Item_Sell_Price } from '@entity/item_sell_price';
// import { Pricechange } from '@entity/price_change';
// import { Group_Pricechange } from '@entity/group_price_change';
// import { Pricechange_Temp } from '@entity/price_change_temp';
// import { SkuService } from '../sku/sku.service';
// import { PsPrice } from '@entity/ps_price';
...
//     private readonly skuRespository: Repository<Sku>,
//     @InjectRepository(PsPrice)
//     private readonly psPriceRespository: Repository<PsPrice>,
//     @InjectRepository(UOM)
//     private readonly uomRespository: Repository<UOM>,
//     @InjectRepository(Item_Sell_Price)
//     private readonly itemSellPriceRespository: Repository<Item_Sell_Price>,
//     @InjectRepository(Pricechange)
//     private readonly pricechangeRespository: Repository<Pricechange>,
//     @InjectRepository(Pricechange_Temp)
//     private readonly pricechangeTempRespository: Repository<Pricechange_Temp>,
//     @InjectRepository(Group_Pricechange)
//     private readonly groupPricechangeRespository: Repository<Group_Pricechange>,
//   ) {}
...
//     const wbs = {},
//       wss = {};
//     const storeFolders = await fs.readdir(`pfprices/xlsx`);
//     for (const storeFolder of storeFolders) {
//       const filesName = await fs.readdir(`pfprices/xlsx/${storeFolder}`);
//       for (const filename of filesName) {
//         console.log(`Process file ${storeFolder}/${filename}`);
//         let wb = new ExcelJS.Workbook();
//         wb = await wb.xlsx.readFile(`pfprices/xlsx/${storeFolder}/${filename}`);
//         const pfPrices = [];
//         wb.eachSheet((ws) => {
...
//               filename: `pfprices/dept/${pfPrice.dept}.xlsx`,
//             });
...
//       filename: `pfprices/report/missingInPS.xlsx`,
//     });
...
//     const wbs = {},
//       wss = {};
//     const filesName = await fs.readdir(`pfprices/dept`);
...
//       const pfPrices = [];
//       const wbPF = new ExcelJS.stream.xlsx.WorkbookReader(`pfprices/dept/${fileName}`, {});
...
//       }
//       try {
//         await fs.access(`psprices/${fileName}`);
...
//               filename: `pfprices/report/${pfPrice.store}.xlsx`,
//             });
